		...
		?>
			...
			<?php 
				...
				if($options['custom_footertext'] != '' ){
					...
					<p>&copy; <?php echo date('Y'); ?> <?php bloginfo(); ?>  | <?php _e('Proudly powered by', 'nilmini') ?> <a href="http://wordpress.org/" >WordPress</a><span class="sep"> | </span><?php printf( __( 'Theme: %1$s by %2$s', 'nilmini' ), 'Nilmini', '<a href="http://www.elmastudio.de/wordpress-themes/">Elmastudio</a>' ); ?></p>
			<?php } ?>
