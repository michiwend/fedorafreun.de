...
function theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<h2><?php printf( __( '%s Theme Options', 'nilmini' ), get_current_theme() ); ?></h2>
		<?php settings_errors(); ?>
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Custom Favicon', 'nilmini' ); ?></th>
					<td>
						...
						<br/><label class="description" for="nilmini_theme_options[custom_favicon]"><?php _e( 'Create a favicon image e.g. with <a href="http://www.faviconr.com/" target="_blank">Faviconr</a>, upload your .ico Favicon image (via FTP) to your server and enter the Favicon URL here.', 'nilmini' ); ?></label>
						</fieldset>
					</td>
				</tr>
